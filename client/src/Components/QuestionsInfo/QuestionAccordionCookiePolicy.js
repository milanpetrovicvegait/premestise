    ...
    render() {
        return (
            ...
            <div className="accordion__content">
                <p>Podaci koje ste uneli u sistem neće biti javno dostupni i služe samo za realizovanje ideje ove aplikacije. Sa obradom podataka se možete detaljnije upoznati kroz <a href="/privacy">Politiku privatnosti.</a> </p>
            </div>
        </div>
        );
    }
